...
namespace uIP.MacroProvider.StreamIO.ImageFileLoader
{
    public partial class FormFolderLoaderSetup : Form
    {
        ...
        private void textBox_parseFilename_TextChanged(object sender, EventArgs e)
        {

        }

        private void comboBox_pluginOpenedFunc_SelectedIndexChanged(object sender, EventArgs e)
        {
