...
namespace uIP.MacroProvider.StreamIO.DividedData
{
    public partial class DataSetSplitter : Form
    {
        ...
        private void btnSplit_Click(object sender, EventArgs e)
        {
            ...
            // 呼叫 Plugin 的公開方法 StartConvertByCode 來執行轉檔
            // 傳入 showMessage = true，在 UI 環境下顯示完成訊息
            Plugin.StartConvertByCode(textBox1.Text, trainRatio, testRatio, valRatio, showMessage: true);
        }
    }
}
