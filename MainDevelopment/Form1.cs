...
namespace MainDevelopment
{
    public partial class Form1 : Form
    {
        ...
        private void bt_VideoToFrame_Test_Click(object sender, EventArgs e)
        {
            ULibAgent.Singleton.SetPluginClassControlByCSharpClassName("uIP.MacroProvider.StreamIO.VideoInToFrame.uMProvidVideoStreamToFrame", "TestForm", null);
        }

        private void bt_DividedDataSet_Test_Click(object sender, EventArgs e)
        {
            ULibAgent.Singleton.SetPluginClassControlByCSharpClassName("uIP.MacroProvider.StreamIO.DividedData.FileDistributor", "TestForm", null);
        }

        private void bt_DrawPictureConvert_Test_Click(object sender, EventArgs e)
        {
            ULibAgent.Singleton.SetPluginClassControlByCSharpClassName("uIP.MacroProvider.TrainConvert.uMProvidTrendChart", "TestForm", null);
        }
        ...
        //
        static string TmpFolderInsp_v2 = @"C:\Users\jordan.liu\Videos\SOPandNon_converted.mp4";


        private void button_VideoToFrame_Click(object sender, EventArgs e)
        {
            var folderpath = "";
            OpenFileDialog dlg = new OpenFileDialog();
            if (!string.IsNullOrEmpty(TmpFolderInsp_v2))
                TmpFolderInsp_v2 = dlg.FileName;
